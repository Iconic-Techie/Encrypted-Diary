...

{
    ...
    printf("\t***********************************");
    printf("\n\n\t\t\t                               MADE BY :");
    printf("\n\t\t\t                   Shruti Gupta    {1900970130116}");
    printf("\n\tI.T.(B)\t\t                   Prachi Baranwal{1900970130078}");
    printf("\n\t\t\t                   Nitesh Kr. Patel    {1900970130074}");
    printf("\n\t\t\t                   Vansh Jindal    {1900970130130}");
    printf("\n\t\t\t                   Rishabh Verma  {1900970130096}");
    printf("\n\t\t\t                   Rahul kr. Gupta  {1900970130090}");  
    printf("\n\t\t\t             ===========================================");
    printf("\n\t\t\t                              Directed By :");
    printf("\n\t\t\t                          Savesh Swarnakar sir");
...

    {
        ...
        case 6:
            ...
            printf("\n\n\tPlease provide your valuble feedback on my mail : \n\t>>shrutiguptajk@gmail.com");
